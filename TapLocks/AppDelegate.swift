...
class AppDelegate: NSObject, NSApplicationDelegate, KeyboardBlockerDelegate, NSPopoverDelegate {
    ...
    func showAccessibilityAlert() {
        ...
        alert.informativeText = "To unlock the screen securely, you need to enable Accessibility for this app in System Settings > Privacy & Security."
    ...
    func showInputMonitoringAlert() {
        ...
        alert.informativeText = "To fully block keyboard input, you need to enable Input Monitoring for this app in System Settings > Privacy & Security."
        alert.alertStyle = .warning
        alert.addButton(withTitle: "Open Settings")
        alert.addButton(withTitle: "Cancel")
